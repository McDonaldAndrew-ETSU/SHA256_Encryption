...
namespace SHA256_Encryption.Encryption;
...
internal class SHA256
{
    ...
    public uint[] H { get; private set; } = new uint[] {
    ...
    public uint[] K { get; private set; } = new uint[] {
    ...
    private uint a = Convert.ToUInt32("6a09e667", 16);
    private uint b = Convert.ToUInt32("bb67ae85", 16);
    private uint c = Convert.ToUInt32("3c6ef372", 16);
    private uint d = Convert.ToUInt32("a54ff53a", 16);
    private uint e = Convert.ToUInt32("510e527f", 16);
    private uint f = Convert.ToUInt32("9b05688c", 16);
    private uint g = Convert.ToUInt32("1f83d9ab", 16);
    private uint h = Convert.ToUInt32("5be0cd19", 16);
    ...
    /// <summary>
    /// The encryption method to create a SHA256 hash
    /// </summary>
    /// <param name="input"> a string input </param>
    /// <returns> the hash of the input </returns>
    /// <exception cref="ArgumentOutOfRangeException"> if the string is more than 55 chars </exception>
    ...
    private string StringToBinary(string str)
    {
        ...
        {
            s += Convert.ToString(c, 2).PadLeft(8, '0');
        }
        return s;
    }
    /// <summary>
